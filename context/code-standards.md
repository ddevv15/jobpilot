...
| `NEXT_PUBLIC_APP_URL`           | actions/auth.ts — OAuth `redirectTo` construction |
...
- `@insforge/sdk` — InsForge client (SSR helpers via `@insforge/sdk/ssr`, middleware helper via `@insforge/sdk/ssr/middleware`)
